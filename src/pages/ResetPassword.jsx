...
const ResetPassword = () => {
  ...
  return (
    <AuthWrapper>
      <form onSubmit={handleResetPassword(handleResetPassword)} className="w-full lg:w-[505px] p-6">
        <h1 className="text-3xl font-bold">Reset Password</h1>
        <p className="text-[16px] font-medium text-[#666]">Enter your new password</p>
        {/* Password */}
